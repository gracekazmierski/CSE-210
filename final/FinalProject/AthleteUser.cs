public class AthleteUser: User
{
    ...
    public override void WeightLossCalc()
    {
        ...
        {
        Console.WriteLine("================================================");
        Console.WriteLine("The number of reccomended pounds to lose each week is 0.5 - 3 pounds.\n");
        ...
        double _lossChoice = Convert.ToDouble(Console.ReadLine());
            ...
            {
                Console.WriteLine("It is not reccomended that you lose more than 3 pounds per week.");
            }
    ...
    public override void WeightGainCalc()
    {
        ...
        {
        Console.WriteLine("================================================");
        Console.WriteLine("The number of reccomended pounds to gain each week is 0.5 - 3 pounds.\n");
        ...
        double _gainChoice = Convert.ToDouble(Console.ReadLine());
            ...
            {
                Console.WriteLine("It is not reccomended that you gain more than 3 pounds per week.");
            }
