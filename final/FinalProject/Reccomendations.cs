...
{    
    // method to give recommendations based on the user's BMI
    public static void BMIRecommendation(User user) 
    {
        Console.Clear();
        user.CalcBMI();
        ...
        if (user.BMI < 18.5)
        {
            ...
            Console.WriteLine("It is recommended that you aim to gain 0.5-1 lbs. per week.");
        }
    ...
    // method to give user recommendations based on activity level
    public static void FitnessRec(User user) 
    { 
    ...
    // method to give sleep recommendations based on the user's profile type and age
